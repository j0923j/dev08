...
class Interfaces(models.Model):
    ...
    name = models.CharField(max_length=15, verbose_name='接口名称', help_text='接口名称')
    tester  = models.CharField(verbose_name='接口测试人', help_text='接口测试人',max_length=13)
    ...
    project = models.ForeignKey(to='projects.Projects',on_delete=models.CASCADE)
